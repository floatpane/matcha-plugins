    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-slate-500 text-sm">Loading marketplace...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-xl mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-lg shadow-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-slate-900 placeholder:text-slate-400"
            />
          </div>
    ...
    <div className="group bg-white border border-slate-200 rounded-lg p-6 hover:shadow-lg hover:border-emerald-200 transition-all duration-200">
      ...
      <div className="flex gap-2">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="px-3 py-2 border border-slate-200 hover:border-slate-300 text-slate-700 rounded-md transition-colors flex items-center justify-center"
